...
public class app {
    ...
    static void Mod(){
        ...
        System.out.println("bölümden kalan sayı : " + dividend%divisor);
    }
    static void rectangle(){
        Scanner scan = new Scanner(System.in);
        System.out.print("Dikdörtgenin bir uzunluğunu giriniz : ");
        int side1 = scan.nextInt();
        System.out.print("Dikdörtgenin diğer uzunluğunu giriniz : ");
